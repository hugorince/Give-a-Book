-- AlterTable
ALTER TABLE "Booking" ADD COLUMN     "chatId" INTEGER;
...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_chatId_fkey" FOREIGN KEY ("chatId") REFERENCES "Chat"("id") ON DELETE SET NULL ON UPDATE CASCADE;
